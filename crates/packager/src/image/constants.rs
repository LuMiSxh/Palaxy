...
pub const AVIF_QUALITY_TINY: f32 = 68.0;

/// Base quality for small images (< 1M pixels ~800x1200).
/// Older scans or compressed sources - maintain detail.
pub const AVIF_QUALITY_SMALL: f32 = 65.0;

/// Base quality for medium images (< 3M pixels ~1400x2100).
/// **Most manga pages fall here** - optimized for minimum size.
pub const AVIF_QUALITY_MEDIUM: f32 = 62.0;

/// Base quality for large images (< 6M pixels ~2000x3000).
/// High-res scans - can afford lower quality for significant size savings.
pub const AVIF_QUALITY_LARGE: f32 = 58.0;

/// Base quality for huge images (≥ 6M pixels, double spreads).
/// Very large images compress well even at lower quality.
pub const AVIF_QUALITY_HUGE: f32 = 55.0;
...
/// Quality reduction applied to grayscale images.
/// Grayscale line art is very resilient to quality reduction.
/// This saves significant space with no visible loss on manga content.
pub const AVIF_GRAYSCALE_QUALITY_REDUCTION: f32 = 5.0;
...
/// Most manga pages - optimized for minimum size.
...
/// Quality reduction applied to grayscale images for WebP.
/// Grayscale line art tolerates aggressive quality reduction.
