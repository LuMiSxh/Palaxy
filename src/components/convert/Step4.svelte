...
<div class="h-full w-full p-3">
	...
	{:else}
		...
		<BentoGrid cols={2} density="comfortable" class="h-full">
			...
			<BentoItem variant="glass" class="flex flex-col gap-4 overflow-y-auto">
			...
			<BentoItem variant="glass" class="flex flex-col">
				...
				{#if convState.chapterSizes.length > 0}
					<div class="custom-scrollbar flex-1 space-y-3 overflow-y-auto pr-2">
