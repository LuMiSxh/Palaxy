...
{#if !isComplete}
	<div class="w-full p-3 pb-3">
		<VStack gap="md" class="mx-auto max-w-6xl">
...
{:else}
	...
	<div class="flex w-full flex-col items-center justify-center p-3 pb-3">
		<VStack gap="md" class="w-full max-w-2xl">
			<BentoGrid cols={1} density="compact">
				<!-- Header -->
				<BentoItem class="text-center">
				...
				<BentoItem>
					...
					<div class="grid grid-cols-2 gap-4">
						...
						<div
							class="bg-error/10 border-error/20 flex flex-col items-center rounded-lg border p-3"
						>
							<HStack align="center" gap="sm" class="mb-2">
